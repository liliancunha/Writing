...
\end{figure*}
	...
	\end{eqnarray}
	The fourth raw moment of $v_{\mathrm{los}}$ is given taking Eq.~\ref{eq:los_vel_equivalence} and averaging as below
	...
	\begin{eqnarray}
		...
		& -12 \left[\left\langle  v_{\mathrm{r}}v^2_{\mathrm{T}}\right\rangle - \left\langle  v_{\mathrm{r}}\right\rangle \left\langle v^2_{\mathrm{T}}\right\rangle\right]\left\langle v_{\mathrm{r}}\right\rangle\cos^2\theta\sin^2\theta
	\end{eqnarray}
	\begin{eqnarray}
