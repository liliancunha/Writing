...
\begin{document}
	...
	\begin{figure}
		...
		\caption{Characterising the relative line-of-sight velocity distribution}
		\label{fig:old_str}
	\end{figure}
	...
	\subsection{Can we use pairwise velocity?}
	
	The relative line-of-sight velocity can be related to the radial and tangential pairwise velocity as follows
	...
	\end{eqnarray}
	\noindent where $v_{\mathrm{r}}$ and $v_{\mathrm{T}}$ are the radial and tangential components of the pairwise velocity respectively. They are defined as
	\begin{eqnarray}
	...
	On averaging Eq.~\ref{eq:los_vel_equivalence}, we see that 
	\begin{eqnarray}
	...
	\end{eqnarray}
	\noindent However due to isotropy, $\langle v_{\mathrm{T}}\rangle = 0$. Mean of the relative line-of-sight velocity is then
	...
	\begin{eqnarray}
		\left\langle v^2_{\mathrm{los}} \right\rangle = \left\langle v^2_{\mathrm{r}}\right\rangle \cos^2\theta + \left\langle v^2_{\mathrm{T}}\right\rangle\sin^2\theta \, ,
	\end{eqnarray}	
	\noindent where we have used $\left\langle v_{\mathrm{r}} v_{\mathrm{T}}\right\rangle$ = 0. This has indeed been checked from the simulation and assured that this holds. In fact any term involving averaging of odd power of $v_{\mathrm{T}}$ disappears due to the isotropy.  The second cumulant is then given as 
	\begin{eqnarray}
		\sigma^2_{\mathrm{los}} = & \left\langle v^2_{\mathrm{los}} \right\rangle - \left\langle v_{\mathrm{los}} \right\rangle^2 \\
		= &  \sigma^2_{\mathrm{r}} \cos^2\theta + \sigma^2_{\mathrm{T}} \sin^2\theta
	\end{eqnarray}
	...
	\end{eqnarray}
	\noindent The third cumulant of the relative line-of-sight velocity is defined as
	\begin{eqnarray}
	...
	\end{eqnarray}	
	\noindent Using Eqs.~\ref{eq:v1}, \ref{eq:v2} and \ref{eq:v3}, it can be rewritten as
	\begin{multline}
