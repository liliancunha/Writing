...
\end{figure*}
	...
	\end{eqnarray}
	\noindent where $\left\langle v^3_{\mathrm{r}}v_{\mathrm{T}}\right\rangle = \left\langle v_{\mathrm{r}}v^3_{\mathrm{T}}\right\rangle = 0$. Combining Eqs.~\ref{eq:v1}, \ref{eq:v2}, \ref{eq:v3} and \ref{eq:v4}, we can rewrite Eq.~\ref{eq:c4} as
	\begin{eqnarray}
