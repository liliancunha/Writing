...
%	
	...
	\noindent where $K_{\lambda}$ is the modified Bessel function of the third kind with index of $\lambda$. The strength of GH distribution is that it has many subclasses and in limiting cases can take the form of Gaussian, Student-t, hyperbolic and other distributions. 
	
	GH is the mixture modeling consisting of normal distribution and Generalised Inverse Gaussian distribution. 
